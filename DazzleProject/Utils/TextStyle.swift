...
extension View {
    ...
    public func size19Regular() -> some View {
        self.font(.system(size: 19, weight: .regular))
    }
    
    public func size19Medium() -> some View {
        self.font(.system(size: 19, weight: .medium))
    }

    public func size19Bold() -> some View {
        self.font(.system(size: 19, weight: .bold))
    }
    
    public func size20Regular() -> some View {
